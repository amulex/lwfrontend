...
export class Answer {
   ...
   */
  public onOffer = (
    config: PredefinedPeerConfig,
    beforeAnswer: (answerer: WebRtcPeer, from: Connection) => MaybePromiseVoid,
  ) => {
...
const createIceProcessingPeer = (
  config: PredefinedPeerConfig,
  signal: Signal_SessionTo,
  onSignal: OnSignal_SessionFrom,
): WebRtcPeer => {
