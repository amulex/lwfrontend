...
import { Connection, Publisher, PublisherProperties, Session, StreamEvent, StreamManager, Subscriber, VideoElementEvent } from 'openvidu-browser';
...
export class LiveWidgetApi {
    ...
    private async connectAllToAll(connectOptions: ConnectOptions, customProperties = {}) {
        ...
        const publisher = await openviduSession.openvidu.initPublisherAsync(this.elements.streamsTargets.publisher, properties);
